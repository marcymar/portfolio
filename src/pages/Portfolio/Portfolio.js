  ...
  return (
    <div>
      <Card className="card" style={{ margin: '20px' }}>
        ...
        <CardLink href="https://nicholasd-uci.github.io/manhattanProject/" target="_blank">App Link</CardLink>
      </Card>
      <Card className="card" style={{ margin: '20px' }}>        
      <CardBody>
        ...
        <CardLink href="https://frozen-headland-30044.herokuapp.com/" target="_blank">App Link</CardLink>
      </Card>
      <Card className="card" style={{ margin: '20px' }}>
        <CardBody>
        ...
        <CardLink href="https://cryptic-savannah-70126.herokuapp.com/index.html" target="_blank">App Link</CardLink>
      </Card>
      <Card className="card" style={{ margin: '20px' }}>
        <CardBody>
        ...
        <CardBody>
          ...
          <CardLink href="https://github.com/marcymar/READMEgenerator" target="_blank">App Link</CardLink>
        </CardBody>
      </Card>
      <Card className="card" style={{ margin: '20px' }}>
        <CardBody>
        ...
        <CardBody>
          ...
          <CardLink href="https://github.com/marcymar/teambuilder" target="_blank">App Link</CardLink>
        </CardBody>
      </Card>
      <Card className="card" style={{ margin: '20px' }}>
        <CardBody>
        ...
        <CardBody>
          ...
          <CardLink href="https://github.com/marcymar/employeeTracker" target="_blank">App Link</CardLink>
        </CardBody>
      </Card>
    </div>
  )
