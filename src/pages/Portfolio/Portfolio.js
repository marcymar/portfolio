  ...
  return (
    <div>
      <Card>
        ...
        <img width="100%" src="/assets/project1screencap.png" alt="NutraPrep" />
        <CardBody>
      ...
      <Card>
        ...
        <img width="100%" src="/assets/eatdaburger(2).png" alt="Eat-Da-Burger" />
        <CardBody>
      ...
      <Card>
        ...
        <img width="100%" src="/assets/tractivity.png" alt="TrAcktivity" />
        <CardBody>
      ...
      <Card>
        ...
        <img width="100%" src="./assets/readmegenerator.png" alt="ReadMe Generator" />
        <CardBody>
      ...
      <Card>
        ...
        <img width="100%" src="./assets/teambuild.png" alt="Team Builder" />
        <CardBody>
      ...
      <Card>
        ...
        <img width="100%" src="./assets/employeemanager.png" alt="Employee Manager" />
        <CardBody>
